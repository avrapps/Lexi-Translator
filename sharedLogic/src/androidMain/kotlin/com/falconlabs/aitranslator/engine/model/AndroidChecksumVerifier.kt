...
/**
 * Android implementation of [ChecksumVerifier] using java.security.MessageDigest.
 * Identical to JVM implementation since Android supports the same crypto APIs.
 */
class AndroidChecksumVerifier : ChecksumVerifier {
