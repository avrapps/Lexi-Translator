...
@Composable
private fun VoiceLibraryScreenPhoneLightPreview() {
...
@Composable
private fun VoiceLibraryScreenPhoneDarkPreview() {
...
@Composable
private fun VoiceLibraryScreenTabletLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        VoiceLibraryScreen()
    }
}
...
@Composable
private fun VoiceLibraryScreenTabletDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        VoiceLibraryScreen()
    }
}
...
@Composable
private fun VoiceLibraryScreenDesktopLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        VoiceLibraryScreen()
    }
}
...
@Composable
private fun VoiceLibraryScreenDesktopDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        VoiceLibraryScreen()
    }
}
