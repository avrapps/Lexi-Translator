...
@Composable
private fun LiveInterpreterScreenPhoneLightPreview() {
...
@Composable
private fun LiveInterpreterScreenPhoneDarkPreview() {
...
@Composable
private fun LiveInterpreterScreenTabletLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        LiveInterpreterScreen()
    }
}
...
@Composable
private fun LiveInterpreterScreenTabletDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        LiveInterpreterScreen()
    }
}
...
@Composable
private fun LiveInterpreterScreenDesktopLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        LiveInterpreterScreen()
    }
}
...
@Composable
private fun LiveInterpreterScreenDesktopDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        LiveInterpreterScreen()
    }
}
