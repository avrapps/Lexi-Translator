...
@Composable
private fun DocumentPlayerScreenPhoneLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        DocumentPlayerScreen()
    }
}

@Preview(name = "Phone Dark", widthDp = 360, heightDp = 800, showBackground = true)
@Composable
private fun DocumentPlayerScreenPhoneDarkPreview() {
...
@Composable
private fun DocumentPlayerScreenTabletLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        DocumentPlayerScreen()
    }
}
...
@Composable
private fun DocumentPlayerScreenTabletDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        DocumentPlayerScreen()
    }
}
...
@Composable
private fun DocumentPlayerScreenDesktopLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        DocumentPlayerScreen()
    }
}
...
@Composable
private fun DocumentPlayerScreenDesktopDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        DocumentPlayerScreen()
    }
}
