...
@Composable
private fun TextTranslateScreenPhoneLightPreview() {
...
@Composable
private fun TextTranslateScreenPhoneDarkPreview() {
...
@Composable
private fun TextTranslateScreenTabletLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        TextTranslateScreen()
    }
}
...
@Composable
private fun TextTranslateScreenTabletDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        TextTranslateScreen()
    }
}
...
@Composable
private fun TextTranslateScreenDesktopLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        TextTranslateScreen()
    }
}
...
@Composable
private fun TextTranslateScreenDesktopDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        TextTranslateScreen()
    }
}
