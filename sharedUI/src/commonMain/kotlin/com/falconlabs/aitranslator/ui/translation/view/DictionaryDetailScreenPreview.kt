...
@Composable
private fun DictionaryDetailScreenPhoneLightPreview() {
...
@Composable
private fun DictionaryDetailScreenPhoneDarkPreview() {
...
@Composable
private fun DictionaryDetailScreenTabletLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        DictionaryDetailScreen()
    }
}
...
@Composable
private fun DictionaryDetailScreenTabletDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        DictionaryDetailScreen()
    }
}
...
@Composable
private fun DictionaryDetailScreenDesktopLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        DictionaryDetailScreen()
    }
}
...
@Composable
private fun DictionaryDetailScreenDesktopDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        DictionaryDetailScreen()
    }
}
