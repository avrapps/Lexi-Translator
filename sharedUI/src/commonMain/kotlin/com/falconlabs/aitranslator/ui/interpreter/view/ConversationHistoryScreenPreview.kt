...
@Composable
private fun ConversationHistoryScreenPhoneLightPreview() {
...
@Composable
private fun ConversationHistoryScreenPhoneDarkPreview() {
...
@Composable
private fun ConversationHistoryScreenTabletLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        ConversationHistoryScreen()
    }
}
...
@Composable
private fun ConversationHistoryScreenTabletDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        ConversationHistoryScreen()
    }
}
...
@Composable
private fun ConversationHistoryScreenDesktopLightPreview() {
    MaterialTheme(colorScheme = lightColorScheme()) {
        ConversationHistoryScreen()
    }
}
...
@Composable
private fun ConversationHistoryScreenDesktopDarkPreview() {
    MaterialTheme(colorScheme = darkColorScheme()) {
        ConversationHistoryScreen()
    }
}
